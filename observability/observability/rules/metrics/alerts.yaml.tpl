  ...
  - name: DSO_ArgoCD
    rules:
      ...
      - alert: Argo CD Redis HA not available
        annotations:
          message: Argo CD Redis HA in namespace $namespace has not been available for the last 5 minutes.
      ...
      - alert: Argo CD Pod not healthy
        ...
        expr: |
          ...
          pod=~".*",
          container!~"secret-init", namespace="{{ .Values.namespace_prefix }}argocd"} == 1
        for: 5m
        labels:
          severity: warning
