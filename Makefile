...
# numerique.gouv/socle-bundle:$VERSION and numerique.gouv/socle-catalog:$VERSION.
IMAGE_TAG_BASE ?= numerique.gouv/socle
...
IMG ?= lasuite/pi-operator:v1alpha
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/ansible-operator-plugins/releases/download/v1.34.3/ansible-operator_$(OS)_$(ARCH) ;\
